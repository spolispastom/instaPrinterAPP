...
namespace InstagramPrint
{
    public class AutoFilteredComboBox : ComboBox
    {
        ...
        public AutoFilteredComboBox()
        {
            ...
            this.Loaded += AutoFilteredComboBox_Loaded;
        }

        void AutoFilteredComboBox_Loaded(object sender, RoutedEventArgs e)
        {
            EditableTextBox.TextChanged += TagBox_TextChanged;
        }

        private void TagBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            TextBox TagBox = sender as TextBox;
            int selectionStart = TagBox.SelectionStart;
            int selectionLength = TagBox.SelectionLength;

            TagBox.Text = TagBox.Text.ToLower();

            TagBox.SelectionStart = selectionStart;
            TagBox.SelectionLength = selectionLength;
        }
